<?php
	...
	class RasterImageFactoryTest extends TestCase
	{
		...
		public function testOpen_vips_png() {
			...
			$this->withTempTestImage('test.png', function($file) use ($f) {
				...
				$this->assertColorMatching(
					[255, 255, 255, 1],
					[$color->getValue(ColorInterface::COLOR_RED), $color->getValue(ColorInterface::COLOR_GREEN), $color->getValue(ColorInterface::COLOR_BLUE), (int)($color->getAlpha() / 100)]
				);
		...
		public function testCreate_vips() {
			...
			$img = $f->create(new Box(100, 100), (new RGB())->color("ff0000", 1));
